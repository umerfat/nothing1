    ...
    <section class="section-wrap testimonials">
      <div class="container">
        ...
        <div class="row heading-row mb-60">
          <div class="col-md-12 text-center">
            <h2 class="heading uppercase">Happy Clients</h2>
          </div>
        </div>
        ...
        <div id="owl-testimonials" class="owl-carousel owl-theme owl-dark-dots text-center">
          ...
          <div class="item">
            <div class="testimonial">
              <p class="testimonial-text">El punto de usar Lorem Ipsum es que tiene una distribución más o menos normal de las letras, al contrario de usar textos como por ejemplo "Contenido aquí, contenido aquí".</p>
              <span class="uppercase">Pheobe / Google</span>
            </div>
          </div>
          ...
          <div class="item">
            <div class="testimonial">
              <p class="testimonial-text">El punto de usar Lorem Ipsum es que tiene una distribución más o menos normal de las letras, al contrario de usar textos como por ejemplo "Contenido aquí, contenido aquí"..</p>
              <span class="uppercase">Rachel Green / Apple</span>
            </div>
          </div>
