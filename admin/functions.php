...
function register_customer(){
    if (isset($_POST['lb_cus_register'])) {
        ...
        global $connection;
        $first_name        = clean($_POST['cus_first_name']);
        $last_name         = clean($_POST['cus_last_name']);
        ...
        $query_select = "SELECT * FROM tbl_customer";
        $select_cutomer = mysqli_query($connection, $query_select) or printf(mysqli_error($connection));
        ...
        $query  = "INSERT INTO tbl_customer(customer_firstname, customer_lastname, customer_email, customer_phone, customer_password)";
        $query .= "VALUES(?, ?, ?, ?, ?)";
        $stmt   = mysqli_prepare($connection,$query);
        mysqli_stmt_bind_param($stmt,"sssss", $first_name, $last_name, $email, $phone, $encrypted_password);
        ...
        if (!$query_result){
            ...
            echo validation_success("Congratulations {$first_name}! your account has been created! You can Login now");
        }
    }
}
