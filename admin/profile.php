                        ...
                        <form class="form-horizontal form-label-left" action="" method="post"
                            ...
                            <div class="item form-group">
                                <div class="col-md-10 col-sm-12 col-xs-12 marginLeft">
                                    <?php
                                    if (empty($user_image)){
                                        echo "<img src='../USER_IMAGES/default_image.png' width='200' alt='' class='img-responsive'>";
                                    }
                                    else{
                                        echo "<img src='../USER_IMAGES/$user_image' width='200' alt='' class='img-responsive'>";
                                    }
                                    ?>
                            ...
                            <div class="item form-group">
                                <div class="col-md-10 col-sm-12 col-xs-12 marginLeft">
                                    <select class="form-control" name="role">
                                        <option value="Staff"><?php echo $user_role; ?></option>
                                        <?php
                                        if ($user_role == 'Admin'){
