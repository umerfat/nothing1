    ...
    ?>
        <form method="POST" action="" class="form-horizontal" name="customerRegisterForm" id="customerRegisterForm" onsubmit="javascript: return //validateCustomer();">
            <div class="form-group">
                <div class="col-xs-12">
                    <input type="text" placeholder="First Name" class="form-control" name="cus_first_name" id="cus_first_name">
                </div>
            </div>
            <div class="form-group">
                <div class="col-xs-12">
                    <input type="text" placeholder="Last Name" class="form-control" name="cus_last_name" id="cus_last_name">
                </div>
            </div>
            <div class="form-group">
                <div class="col-xs-12">
